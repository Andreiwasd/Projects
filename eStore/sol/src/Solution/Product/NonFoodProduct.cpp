...
{
	if (this->producer == obj.producer && this->yearsOfWarranty == obj.yearsOfWarranty && this->price == obj.price &&
	 this->id == obj.id && this->name == obj.name && this->quantity == obj.quantity && this->category == obj.category)
		return true;
	else
		return false;
	//throw("undefined");
